    ...
    methods: {
        async fetchBoardData() {
            try {
                ...
                this.form.dueDate = board.dueDate;
                this.form.region = board.region;
                this.form.roleCategory = board.roleCategory;
                this.form.tags = board.tags;
            } catch (error) {
        ...
        async submitForm() {
            try {
                ...
                const response = await axios.put(`http://localhost:8080/board/${this.id}`, payload, {
                    headers: {
